object MainForm: TMainForm
  ...
  object MainMenu: TMainMenu
    ...
    object miScheme: TMenuItem
      ...
      object miAddRThread: TMenuItem
        Caption = #1044#1086#1073#1072#1074#1080#1090#1100' '#1085#1080#1090#1100' '#1089#1087#1088#1072#1074#1072
        OnClick = miAddRThreadClick
      end
      object miAddLThread: TMenuItem
        Caption = #1044#1086#1073#1072#1074#1080#1090#1100' '#1085#1080#1090#1100' '#1089#1083#1077#1074#1072
        OnClick = miAddLThreadClick
      end
      object miDelRThread: TMenuItem
        Caption = #1059#1076#1072#1083#1080#1090#1100' '#1085#1080#1090#1100' '#1089#1087#1088#1072#1074#1072
        OnClick = miDelRThreadClick
      end
      object miDelLThread: TMenuItem
        Caption = #1059#1076#1072#1083#1080#1090#1100' '#1085#1080#1090#1100' '#1089#1083#1077#1074#1072
        OnClick = miDelLThreadClick
      end
      object N2: TMenuItem
        Caption = '-'
      end
      object miGroup: TMenuItem
        Caption = #1043#1088#1091#1087#1087#1080#1088#1086#1074#1072#1090#1100' '#1087#1086' '#1094#1074#1077#1090#1072#1084
